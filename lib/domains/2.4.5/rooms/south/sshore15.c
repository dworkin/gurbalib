...
void setup(void) {
   ...
   add_exit("south", DIR + "/rooms/south/sforst41.c");
   add_exit("west", DIR + "/rooms/south/sforst40.c");
   add_exit("northwest", DIR + "/rooms/south/sshore16.c");
   add_exit("southeast", DIR + "/rooms/south/sshore14.c");
}
