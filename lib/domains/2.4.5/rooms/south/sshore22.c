...
void setup(void) {
   ...
   add_exit("north", DIR + "/rooms/south/sforst21.c");
   add_exit("west", DIR + "/rooms/south/sforst27.c");
   add_exit("northeast", DIR + "/rooms/south/sshore23.c");
   add_exit("southwest", DIR + "/rooms/south/sshore21.c");
}
