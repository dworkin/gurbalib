...
void setup(void) {
   ...
   add_exit("south", DIR + "/rooms/south/sforst33.c");
   add_exit("west", DIR + "/rooms/south/sforst31.c");
   add_exit("northwest", DIR + "/rooms/south/sshore19.c");
   add_exit("southeast", DIR + "/rooms/south/sshore17.c");
}
