...
void setup( void ) {
   ...
   add_item("gate", "The ancient stonework of the gate is etched with the inscription 'Scientia et Pertinacia.'  Beyond it the dirt road leads toward a large open field.");
}
