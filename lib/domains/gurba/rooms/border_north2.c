...
void setup(void) {
   ...
   set_long("You are on the Border Walk, the long and narrow street " +
      ...
      "lies to your north. To the west there seems to be a turn in the " +
      "road, and the walk continues to the east.");

   set_exits(([
      "west" : DIR + "/rooms/border_north1",
      "east" : DIR + "/rooms/border_north3",
   ]));
}
