...
void follow_fudge( void ) {
  ...
  if( nFudgeHere == 0 ) {
    ...
    if( query_environment() != fudge->query_environment() ) {
      switch( random( 10 ) ) {
      case 0: query_environment()->tell_room( 0, "Bob leaves.");
         break;
      case 1: query_environment()->tell_room( 0,
         "Bob tries to follow his master.");
         break;
      case 2: query_environment()->tell_room( 0, "Bob follows Fudge.");
         break;
      case 3: query_environment()->tell_room( 0,
         "Bob disappears in a cloud of smoke.");
         break;
      case 4: query_environment()->tell_room( 0, "Bob suddenly vanishes.");
         break;
      case 5: query_environment()->tell_room( 0, "Bob fades out of view.");
         break;
      case 6: query_environment()->tell_room( 0, "Bob runs off after Fudge.");
         break;
      case 7: query_environment()->tell_room( 0,
         "Bob suddenly notices that Fudge has left, and runs off.");
         break;
      case 8: query_environment()->tell_room( 0,
         "Bob fades into the shadows, and is gone.");
         break;
      case 9: query_environment()->tell_room( 0,
      ...
      switch( random( 10 ) ) {
      case 0: query_environment()->tell_room( 0, 
         "Bob follows the light of his life.");
         break;
      case 1: query_environment()->tell_room( 0, 
         "Bob follows in his masters footsteps.");
         break;
      case 2: query_environment()->tell_room( 0, 
         "Bob appears next to Fudge in a cloud of smoke.");
         break;
      case 3: query_environment()->tell_room( 0, "Bob enters.");
         break;
      case 4: query_environment()->tell_room( 0, "Bob appears.");
         break;
      case 5: query_environment()->tell_room( 0,
         "Bob arrives shortly after Fudge.");
         break;
      case 6: query_environment()->tell_room( 0,
         "Bob comes running, tying to keep up with Fudge.");
         break;
      case 7: query_environment()->tell_room( 0, "A humble slave enters.");
         break;
      case 8: query_environment()->tell_room( 0,
         "A humble person wearing a robe enters.");
         break;
      case 9: query_environment()->tell_room( 0,
         "Bob catches up with Fudge.");
         break;
      }
    }
  }
